<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="WebForm1.aspx.cs" Inherits="WebApplication2.Vehicle.WebForm1" %>
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="col-md-12">
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtvehregno" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                            <tr>
                   ...
                   <td> <div>
                        <asp:TextBox ID="txtregdate" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                        <asp:TextBox ID="txtrtoauth" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
           <asp:DropDownList ID="ddlmanufacturer" runat="server" Width="228px">
               ...
               <asp:ListItem>EICHER</asp:ListItem>
                   ...
                   <td> <div>
                            <asp:DropDownList ID="ddlcompany" runat="server" Width="228px">
                   ...
                   <td> <div>
                        <asp:TextBox ID="txtchassisno" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                            <tr>
                   <td> <label for="txtengineno" class="col-sm-0 col-form-label">Engine No.</label></td>
                   <td> <div>
                        <asp:TextBox ID="txtengineno" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                            <tr>
                    <td> <label for="txtmfgyear" class="col-sm-0 col-form-label">Manufacture Year :</label></td>
                   <td> <div>
                        <asp:TextBox ID="txtmfgyear" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:DropDownList ID="ddlmfgmonth" runat="server" Width="228px">
                   ...
                   <td> <div>
                    ...
                    </div><asp:TextBox ID="txtpurchasedate" runat="server" Width="228px"></asp:TextBox>
                     </td>
                        </tr>
                            <tr>
                   <td> <label for="txtpurchaseamount" class="col-sm-0 col-form-label">Purchase Amount</label></td>
                   <td> <div>
                        <asp:TextBox ID="txtpurchaseamount" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                            <tr>
                   <td> <label for="txttotaltyres" class="col-sm-0 col-form-label">Total Tyres On Purchase :</label></td>
                   <td> <div>
                        <asp:TextBox ID="txttotaltyres" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                           </table></td>
                        <td>
                   ...
                   <td> <div>
                     <asp:DropDownList ID="ddlvehcategory" runat="server" Width="228px">
                   ...
                   <td> <div>
                      <asp:DropDownList ID="ddlbodytype" runat="server" Width="228px">
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtlength" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtwidth" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtheight" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txttotal" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtgrossweight" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtcapacity" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txttotalunloadweight" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtnewgrossweight" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtnewcapacity" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtnewtotalunloadweight" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txttotalcommitmentweight" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td>
                        </tr>
                            <tr>
                   ...
                   <td> <div>
                          <asp:DropDownList ID="ddlloadingtoncapacity" runat="server" Width="228px">
